...
import { Upload, FileAudio, FileVideo, X, Loader2, Youtube, Link } from 'lucide-react'
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-gray-500 text-sm">Аудио, видео файл или ссылка YouTube</p>
      </div>
      ...
      {tab === 'file' ? <FileUpload /> : <YoutubeUpload />}
    </div>
  )
}
